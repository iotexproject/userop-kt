...
class SimpleAccountBuilder(val rpcUrl: String, val signer: ISigner, val opts: PresetBuilderOpts?) : UserOperationBuilder() {
    ...
    companion object {
        ...
        suspend fun init(sender: String?, rpcUrl: String, signer: ISigner, opts: PresetBuilderOpts?): SimpleAccountBuilder {
        ...
        suspend fun init(rpcUrl: String, signer: ISigner, opts: PresetBuilderOpts): SimpleAccountBuilder {
